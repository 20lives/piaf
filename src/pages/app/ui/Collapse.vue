  ...
  <b-row>
    ...
    <b-colxx xxs="12">
        <b-card class="mb-4" :title="$t('collapse.accordion')">
            <div class="border">
                <b-button v-b-toggle.collapseAccordion1 variant="link" block class="text-left">Collapsible Group Item #1</b-button>
            ...
            <div class="border">
                <b-button v-b-toggle.collapseAccordion2 variant="link" block class="text-left">Collapsible Group Item #2</b-button>
            ...
            <div class="border">
                <b-button v-b-toggle.collapseAccordion3 variant="link" block class="text-left">Collapsible Group Item #3</b-button>
